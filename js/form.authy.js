(function() {
  ...
  window.Authy.UI = function() {
    ...
    findAndSetupCountries = function() {
      var countries, i;
      setupCountriesDropdown(document.getElementById(target_field), 0);
      countries = document.getElementsByClassName(target_field);
      i = 0;
    ...
    setCountryField = function() {
      ...
      defaultListId = 0;
      field = document.getElementById(target_field);
      if (!field) {
        return;
      }
  ...
  Authy.UI.instance = function( __target_field ) {
    if (!this.ui) {
      target_field = __target_field;
