...
* Slightly modified for PasswordX so this applies bastardized Concrete5 progress bar classes instead of Bootstrap defaults
*/
...
(function ($, ui) {
    ...
    ui.updateProgressBar = function (options, $el, cssClass, percentage) {
        ...
        $.each(ui.possibleProgressBarClasses, function (idx, value) {
            $bar.parent().removeClass(cssPrefix + "progress-" + value); //changed from bar- to progress- and target parent
        });
        $bar.parent().addClass(cssPrefix + "progress-" + barClasses[cssClass]); //changed from bar- to progress- and target parent
